...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`progarlic`}</title>

        <meta
          name="description"
          content="Welcome to progarlic - Streamlining your trading and operations management for a more efficient and profitable business journey."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to progarlic - Streamlining your trading and operations management for a more efficient and profitable business journey.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1499750310107-5fef28a66643?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFkaW5nJTJDb3BlcmF0aW9ucyUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjg4OTE2MjQ3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
